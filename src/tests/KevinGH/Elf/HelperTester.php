 ...
 */
class HelperTester extends PHPUnit_Framework_TestCase
{
    /**
     ...
     *
     * @param string $format The file name format.
     * @param boolean $temp In temporary directory?
     *
     * @return string The random file name.
     */
    public function randomName($format, $temp = true)
    {
        $name = sprintf($format, rand(1000, 9999));
